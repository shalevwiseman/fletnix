...
class Planner:
    def __init__(self, num_rounds, phase_len, num_arms, num_users, arms_thresh, users_distribution):
        ...
        self.arms_thresh = copy.deepcopy(arms_thresh)
        self.OG_arms_thresh = copy.deepcopy(arms_thresh)
    ...
    def choose_arm(self, user_context):
        ...
        if (self.current_round + 1) % self.phase_len == 0 and self.current_round > 0:
            ...
            self.round_to_thrash = self.OG_arms_thresh.copy()
        ...
        if (self.keep_arms == True) and (self.current_round < self.keeping_length):
            ...
            if (self.phase_len - self.num_round_per_phase) > total_rounds_to_thrash:
                self.max_sample()
